    ...
    <div>
      <ul>
          ...
          <div class="side align-center item-center">
            <div class="sideLeft3 ">
              ...
              <p class="sideLeft3-text">
                Kami menawarkan beragam varietas kopi, mulai dari single origin
                hingga campuran unik, yang akan memenuhi keinginan dan
        ...
        <li class="content6 align-center item-center">
          ...
          <p class="question">
            Jika Anda memiliki pertanyaan untuk kami, silahkan menghubungi team
            kami.
          </p>
          <div class="question">
